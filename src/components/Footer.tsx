      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="md:col-span-1">
            <h3 className="font-display text-3xl font-bold tracking-wider text-[#006c3b] mb-4">AELQEMY</h3>
          ...
          <div>
            <h4 className="text-sm font-sans font-medium uppercase mb-4">Address</h4>
